...
public class HighlighterSettingsProjectConfigurable implements SearchableConfigurable {

    private static final Logger LOGGER = Logger.getInstance(HighlighterSettingsProjectConfigurable.class);
...
//        settingsGUI.apply();
        ...
        projectConfig.storeBackgroundColorInformation(colorAndFontDescriptionPanel.isBackgroundColorEnabled(), colorAndFontDescriptionPanel.getSelectedBackgroundColor());
        HighlightedTabTextAttributesDescription attributesDescription = projectConfig.getAttributesDescription();
